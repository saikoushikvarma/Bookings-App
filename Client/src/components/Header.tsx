      ...
      <header className="py-5 px-4 flex items-center justify-between">
        <Link className="flex items-center gap-1" to={"/"}>
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="size-6 -rotate-90 text-primary"
          >
            <path
              strokeLinecap="round"
        ...
        <div className="flex border border-gray-500 rounded-full px-4 py-2 gap-2 shadow-md shadow-gray-300">
          <span>Any Where</span>
        ...
        <div className="gap-2 flex items-center">
          <span className="text-xl font-medium">Airbnb your home</span>
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <div></div>
          <Link
            to={isEmpty(userName) ? "/login" : "/account"}
            className="flex border border-gray-500 rounded-full px-4 py-2 gap-2"
          >
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            {isEmpty(profileImage) ? (
              ...
              <img
                src={`${baseUrlForImages}${profileImage}`}
